...
import { CompanyResponse, Empresa, EmpresaRequest, PermisoEmpresa, PermisosUsuarioRequest, PermisosUsuarioResponse, UsuarioEmpresa, UsuarioEmpresaRequest } from '../interfaces/administracion';
...
export class AdministracionService {
  ...
  listarPermisos(): Observable<PermisoEmpresa[]> { return this.http.get<PermisoEmpresa[]>(`${this.url}/permisos`); }
