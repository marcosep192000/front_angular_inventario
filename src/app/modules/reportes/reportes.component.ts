...
export class ReportesComponent {
  readonly areas: AreaReporte[] = [
    ...
    { titulo: 'Proveedores', icono: 'local_shipping', color: 'proveedores', items: [{ nombre: 'Comparador y gestión de costos', ruta: 'proveedores' }, { nombre: 'Compras a proveedores', ruta: 'proveedores/compras' }, { nombre: 'Deuda con proveedores', ruta: 'proveedores/deuda' }, { nombre: 'Evolución de costos', ruta: 'proveedores/evolucion-costos' }] },
