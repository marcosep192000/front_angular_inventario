...
export const routes: Routes = [
  ...
  // Agrupar rutas protegidas dentro del dashboa
  {
    ...
    children: [
      ...
      { path: 'cloud-store', loadComponent: () => import('./pages/cloud-store/cloud-store.component').then(m => m.CloudStoreComponent), canActivate: [permissionGuard], data: { permission: 'EMPRESA_CONFIGURAR', allowAdmin: true } },
